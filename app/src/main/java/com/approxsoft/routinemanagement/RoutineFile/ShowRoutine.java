...
public class ShowRoutine {
                ...
                routineReference.child("Department Of CSE And CSIT").child("Routine").child(usersIDs).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot)
                    {
                        if (snapshot.exists()) {
                            ...
                            String DayName = Objects.requireNonNull(snapshot.child("dayName").getValue()).toString();


                            switch (DayName) {
                                case "Saturday":
                                    routineRecordViewHolder.dayName.setText("Sat");
                                    break;
                                case "Sunday":
                                    routineRecordViewHolder.dayName.setText("Sun");
                                    break;
                                case "Monday":
                                    routineRecordViewHolder.dayName.setText("Mon");
                                    break;
                                case "Tuesday":
                                    routineRecordViewHolder.dayName.setText("Tue");
                                    break;
                                case "Wednesday":
                                    routineRecordViewHolder.dayName.setText("Wed");
                                    break;
                                case "Thursday":
                                    routineRecordViewHolder.dayName.setText("Tha");
                                    break;
                                case "Friday":
                                    routineRecordViewHolder.dayName.setText("Fri");
                                    break;
                            }
                            ...
                            AddClassRoom(routineRecordViewHolder.at1,a1t,a1r);
                            AddClassRoom(routineRecordViewHolder.bt1,b1t,b1r);
                            AddClassRoom(routineRecordViewHolder.ct1,c1t,c1r);
                            AddClassRoom(routineRecordViewHolder.dt1,d1t,d1r);
                            AddClassRoom(routineRecordViewHolder.et1,e1t,e1r);
                            AddClassRoom(routineRecordViewHolder.ft1,f1t,f1r);
                            ...
                            AddClassRoom(routineRecordViewHolder.at2,a2t,a2r);
                            AddClassRoom(routineRecordViewHolder.bt2,b2t,b2r);
                            AddClassRoom(routineRecordViewHolder.ct2,c2t,c2r);
                            AddClassRoom(routineRecordViewHolder.dt2,d2t,d2r);
                            AddClassRoom(routineRecordViewHolder.et2,e2t,e2r);
                            AddClassRoom(routineRecordViewHolder.ft2,f2t,f2r);
    ...
    private static void AddClassRoom(TextView at1, String a1t, String a1r) {

        if (!a1r.equals(""))
        {
            at1.setText(String.format("%s  (%s)", a1t, a1r));
        }
        else
        {
            at1.setText(a1t);
    ...
    public static class RoutineRecordViewHolder extends RecyclerView.ViewHolder {
        ...
        View mView;
        View recordView;
        TextView dayName, ac1, bc1,cc1,dc1,ec1,fc1,at1, bt1,ct1,dt1,et1,ft1, ac2, bc2,cc2,dc2,ec2,fc2,at2, bt2,ct2,dt2,et2,ft2,  ac3, bc3,cc3,dc3,ec3,fc3,at3, bt3,ct3,dt3,et3,ft3,
                ac4, bc4,cc4,dc4,ec4,fc4,at4, bt4,ct4,dt4,et4,ft4,  ac5, bc5,cc5,dc5,ec5,fc5,at5, bt5,ct5,dt5,et5,ft5, ac6, bc6,cc6,dc6,ec6,fc6,at6, bt6,ct6,dt6,et6,ft6,
                ac7, bc7,cc7,dc7,ec7,fc7,at7, bt7,ct7,dt7,et7,ft7,  ac8, bc8,cc8,dc8,ec8,fc8,at8, bt8,ct8,dt8,et8,ft8,  ac9, bc9,cc9,dc9,ec9,fc9,at9, bt9,ct9,dt9,et9,ft9,
                ac10, bc10,cc10,dc10,ec10,fc10,at10, bt10,ct10,dt10,et10,ft10, ac11, bc11,cc11,dc11,ec11,fc11,at11, bt11,ct11,dt11,et11,ft11, ac12, bc12,cc12,dc12,ec12,fc12,at12, bt12,ct12,dt12,et12,ft12;
